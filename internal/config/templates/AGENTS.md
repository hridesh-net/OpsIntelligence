...
- **State directory** (e.g. `~/.opsintelligence/`): **SOUL.md**, **IDENTITY.md**, **USER.md**, **AGENTS.md**, **memory/**, **skills/**, config, DBs. This is the primary workspace root for markdown identity and memory files.
